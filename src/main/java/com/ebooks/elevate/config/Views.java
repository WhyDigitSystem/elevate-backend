...
public class Views {
    ...
    private void executeQueries() {
    	...
    	jdbcTemplate.execute("create or replace view vw_elytdtb as\r\n"
    			...
    			+ "    SUM(a.clbalancecr) AS CLBalCredit,\r\n"
    			+ "    CASE \r\n"
    			+ "        WHEN a.natureofaccount = 'Db' AND SUM(a.clbalancedb) > 0 \r\n"
    			+ "            THEN SUM(a.clbalancedb)\r\n"
    			+ "        WHEN a.natureofaccount = 'Cr' AND SUM(a.clbalancecr) > 0 \r\n"
    			+ "            THEN SUM(a.clbalancecr)\r\n"
    			+ "        ELSE SUM(a.clbalancedb) - SUM(a.clbalancecr) \r\n"
