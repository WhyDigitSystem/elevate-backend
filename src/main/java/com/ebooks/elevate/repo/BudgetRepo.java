...
//			+ "    a.natureofaccount,gl.displayseq ORDER BY cast(gl.displayseq as unsigned) ASC")
	...
	@Query(nativeQuery = true, value = "SELECT\r\n"
			...
			+ "			    ROUND(SUM(\r\n"
			+ "			        CASE\r\n"
			+ "			            WHEN a.maingroup IN ('Balance Sheet Schedule', 'Closing Stock', 'Opening Stock')\r\n"
			+ "			                THEN a.budget\r\n"
			+ "			            ELSE a.budget\r\n"
			+ "			        END\r\n"
			+ "			    ), ?9) AS budget,\r\n"
			...
			+ "			FROM (\r\n"
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        SUM(truncate(amount/?8,?9)*?8) AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM budget\r\n"
			+ "			    WHERE orgid = ?1 AND clientcode = ?2 AND year = ?3 AND month = ?5 and maingroup=?6\r\n"
			+ "			    GROUP BY maingroup, subgroup, subgroupcode, accountcode, natureofaccount, accountname\r\n"
			+ "			\r\n"
			+ "			    UNION\r\n"
			+ "			\r\n"
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, SUM(truncate(amount/?8,?9)*?8) AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, SUM(truncate(amount/?8,?9)*?8) AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
			+ "			    WHERE orgid = ?1 AND clientcode = ?2 AND year = ?4 AND month = ?5 and maingroup = ?6\r\n"
			+ "			    GROUP BY maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount\r\n"
			+ "			\r\n"
			+ "			    UNION\r\n"
			+ "			\r\n"
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, SUM(truncate(amount/?8,?9)*?8) AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM budget\r\n"
			+ "			    WHERE orgid = ?1\r\n"
			+ "			      AND clientcode = ?2\r\n"
			...
			+ "			          SELECT monthsequence\r\n"
			+ "			          FROM budget\r\n"
			+ "			          WHERE year = ?3 AND month = ?5 and maingroup = ?6\r\n"
			+ "			          GROUP BY monthsequence\r\n"
			+ "			      )\r\n"
			+ "			    GROUP BY maingroup, subgroup, subgroupcode, accountcode, natureofaccount, accountname\r\n"
			+ "			\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, SUM(truncate(amount/?8,?9)*?8) AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
			+ "			    WHERE orgid = ?1\r\n"
			+ "			      AND clientcode = ?2\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, SUM(truncate(amount/?8,?9)*?8) AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
			+ "			    WHERE orgid = ?1\r\n"
			+ "			      AND clientcode = ?2\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        SUM(truncate(amount/?8,?9)*?8) AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM budget\r\n"
			...
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, SUM(truncate(amount/?8,?9)*?8) AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
			...
			+ " OR fullPY <> 0\r\n"
			+ " OR Estimate <> 0\r\n"
			+ "			ORDER BY CAST(gl.displayseq AS UNSIGNED) ASC")
	Set<Object[]> getELActualDetails(Long orgId, String clientCode, String finyear, String previousYear, String month,
			String mainGroupName, String subGroupCode,int findDivideamount,int decimal);
...
//			+ "GROUP BY h.accountcode, h.accountname")
	@Query(nativeQuery = true, value = "WITH params AS (     SELECT          ?1 AS orgid,\r\n"
			+ "						        ?2 AS currentFinYear,         ?6 AS previousFinYear,         ?3 AS client,\r\n"
			+ "						        ?4 AS maingroup,         ?5 AS currentMonth ), Accounts AS (\r\n"
			+ "						    SELECT          a.displayseq,          a.accountname,\r\n"
			+ "						        a.accountcode,         a.subgroupname,         a.subgroupcode\r\n"
			+ "						    FROM groupledgers a     JOIN groupmapping b ON a.groupmappingid = b.groupmappingid\r\n"
			+ "						    join params p     WHERE b.groupname = p.maingroup       AND a.active = 1\r\n"
			+ "						    GROUP BY a.accountname, a.displayseq, a.accountcode, a.subgroupname, a.subgroupcode\r\n"
			+ "						),budget_data AS (SELECT         b.accountcode,         b.accountname,\r\n"
			+ "						        m.monthsequence,         b.month,         b.year,\r\n"
			+ "						        b.budgetamount AS budget,         b.actualamount AS actual,\r\n"
			+ "						        b.pyamount AS PY,         b.ytbudgetamount AS budgetYTD,\r\n"
			+ "						        b.ytactualamount AS ActYTD,         b.ytpyamount AS PyYTD,\r\n"
			+ "						        b.fullbudgetamount AS fullBudget,         b.estimateamount AS Estimate,\r\n"
			+ "						        b.fullpyamount AS fullPY     FROM budget b      JOIN params p\r\n"
			+ "						      ON b.orgid = p.orgid and b.month = ?5      AND b.client = p.client\r\n"
			+ "						     AND b.maingroup = p.maingroup      AND b.year IN (p.currentFinYear, p.previousFinYear)\r\n"
			+ "						) SELECT     h.accountcode,     h.accountname,\r\n"
			+ "						    ROUND(SUM(h.budget), ?8) AS budget,     ROUND(SUM(h.actual), ?8) AS actual,\r\n"
			+ "						    ROUND(SUM(h.PY), ?8) AS PY,    ROUND(\r\n"
			+ "			        SUM(\r\n"
			+ "			            CASE\r\n"
			+ "			                WHEN 'Profit And Loss' = 'Balance Sheet' THEN h.budget\r\n"
			+ "			                ELSE h.budgetYTD\r\n"
			+ "			            END\r\n"
			+ "			        ), ?8\r\n"
			+ "			    ) AS budgetYTD,\r\n"
			...
			+ "			        SUM(\r\n"
			+ "			            CASE\r\n"
			+ "			                WHEN 'Profit And Loss' = 'Balance Sheet' THEN h.actual\r\n"
			+ "			                ELSE h.ActYTD\r\n"
			+ "			            END\r\n"
			+ "			        ), ?8\r\n"
			+ "			    ) AS ActYTD,\r\n"
			...
			+ "			        SUM(\r\n"
			+ "			            CASE\r\n"
			+ "			                WHEN 'Profit And Loss' = 'Balance Sheet' THEN h.PY\r\n"
			+ "			                ELSE h.PyYTD\r\n"
			+ "			            END\r\n"
			+ "			        ), ?8\r\n"
			+ "			    ) AS PyYTD,\r\n"
			...
			+ "						    -- budget\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           SUM(truncate(amount/?7,?8)*?7) budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid     LEFT JOIN budget b \r\n"
			+ "						        ON acc.accountname = h.subheading         AND b.accountname = j.accountname\r\n"
			+ "						        AND j.accountname = b.accountname         AND j.maingroup = b.maingroup\r\n"
			+ "						        AND j.subgroup = b.subgroup         AND b.year = ?2         AND b.orgid = ?1\r\n"
			+ "						        AND b.clientcode = ?3 AND  b.month = ?5\r\n"
			+ "						    GROUP BY b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount, acc.displayseq\r\n"
			+ "						     UNION      -- actual\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, SUM(truncate(amount/?7,?8)*?7) actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			+ "						        AND b.accountname = j.accountname         AND j.accountname = b.accountname\r\n"
			+ "						        AND j.maingroup = b.maingroup         AND j.subgroup = b.subgroup\r\n"
			+ "						        AND b.year = ?2         AND b.orgid = ?1\r\n"
			+ "						        AND b.clientcode = ?3 AND  b.month = ?5\r\n"
			+ "						    GROUP BY b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount, acc.displayseq\r\n"
			+ "						     UNION      -- PY\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, SUM(truncate(amount/?7,?8)*?7) PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			+ "						        AND b.accountname = j.accountname         AND j.accountname = b.accountname\r\n"
			+ "						        AND j.maingroup = b.maingroup         AND j.subgroup = b.subgroup\r\n"
			+ "						        AND b.year = ?6         AND b.orgid = ?1\r\n"
			+ "						        AND b.clientcode = ?3 AND  b.month = ?5 \r\n"
			+ "						    GROUP BY b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount, acc.displayseq\r\n"
			+ "						     UNION      -- budget YTD\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, SUM(truncate(amount/?7,?8)*?7) budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid     LEFT JOIN budget b \r\n"
			+ "						        ON acc.accountname = h.subheading         AND b.accountname = j.accountname\r\n"
			...
			+ "						     UNION      -- Act YTD\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, SUM(truncate(amount/?7,?8)*?7) ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			...
			+ "						     UNION      -- PY YTD\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, SUM(truncate(amount/?7,?8)*?7) PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			...
			+ "						     UNION      -- full budget\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, SUM(truncate(amount/?7,?8)*?7) fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid     LEFT JOIN budget b \r\n"
			+ "						        ON acc.accountname = h.subheading         AND b.accountname = j.accountname\r\n"
			...
			+ "						     UNION      -- full PY\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, SUM(truncate(amount/?7,?8)*?7) fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			+ "						        AND b.accountname = j.accountname         AND j.accountname = b.accountname\r\n"
			+ "						        AND j.maingroup = b.maingroup         AND j.subgroup = b.subgroup\r\n"
			+ "						        AND b.year = ?6         AND b.orgid = ?1         AND b.clientcode = ?3\r\n"
			+ "						    GROUP BY b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount, acc.displayseq \r\n"
			+ "						    ORDER BY CAST(display_sequence AS UNSIGNED) ) h WHERE h.accountname IS NOT NULL\r\n"
			+ "						GROUP BY h.accountcode, h.accountname")
	Set<Object[]> getELActualDetailsAutomatic(Long orgId, String finyear, String clientCode, String mainGroupName,
			String month, String previousYear,int devideAmount,int decimal);
	...
	@Query(nativeQuery = true, value = "WITH Months AS (\r\n" + "    SELECT 'April' AS month UNION ALL\r\n"
			...
			+ "    GROUP BY a.accountname, a.displayseq, a.accountcode, a.subgroupname, a.subgroupcode\r\n" + ")\r\n"
			+ "SELECT \r\n" + "    acc.accountcode,\r\n" + "    acc.accountname,\r\n" + "    m.month,\r\n"
			+ "    SUM(truncate(b.amount/?5,?6)* ?5) AS total_amount\r\n" + "FROM Months m\r\n" + "CROSS JOIN Accounts acc\r\n"
			+ "LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "LEFT JOIN previousyearactual b \r\n" + "    ON acc.accountname = h.subheading\r\n"
			+ "    AND b.accountname=j.accountname\r\n" + "    AND j.accountname = b.accountname\r\n"
			...
			+ "ORDER BY \r\n" + "    CAST(acc.displayseq AS UNSIGNED),\r\n"
			+ "    FIELD(m.month, 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December', 'January', 'February', 'March')")
	Set<Object[]> getPYDetailsAuto(Long orgId, String finyear, String clientCode, String mainGroupName,int devideAmount,int decimal);
	...
	@Query(nativeQuery = true, value = "SELECT p.month, SUM(p.amount) FROM budget p "
			+ "WHERE p.orgId = ?1 AND p.clientCode = ?2 AND p.year = ?3 "
			+ "AND p.mainGroup = 'Closing Stock' AND p.accountCode IN (?4) " + "GROUP BY p.month")
	List<Object[]> getDrawingPowerMonthWiseSum(Long org, String clientcode, String yr, List<String> accountCodeList);

	@Query(nativeQuery = true, value = "SELECT p.month, SUM(p.amount) FROM budget p "
			+ "WHERE p.orgId = ?1 AND p.clientCode = ?2 AND p.year = ?3 "
			+ "AND p.mainGroup = 'Closing Stock' AND p.accountCode = '4009' " + "GROUP BY p.month")
	...
	@Query(nativeQuery = true, value = "SELECT\r\n" + "a.department,a.category,\r\n"
			...
			+ "          AND month = ?5 AND LENGTH(TRIM(employmenttype))>0\r\n"
			...
			+ "          AND month = ?5 AND LENGTH(TRIM(employmenttype))>0\r\n"
			+ "    GROUP BY department,category\r\n" + ") a\r\n" + "GROUP BY\r\n" + "   a.department,a.category")
	Set<Object[]> getELActualHeadCountReport(Long orgId, String clientCode, String finYear, String previousYear,
			String month);

	@Query(nativeQuery = true, value = "SELECT supplier,SUM(slab1) slab1,SUM(slab2) slab2,SUM(slab3) slab3,SUM(slab4) slab4,SUM(slab5) slab5,SUM(slab6) slab6, sum(outstanding)outstanding\r\n"
	...
	@Query(nativeQuery = true, value = "SELECT \r\n" + "    a.description,\r\n"
			...
			+ "        AND description NOT IN ('GST', 'Gross Sales', 'Avg Percentage of GST')\r\n"
			+ "    GROUP BY description\r\n" + ") a\r\n" + "GROUP BY a.description order by ROUND(SUM(a.ActYTD), 2) desc")
	...
	@Query(nativeQuery = true, value = "WITH Accounts AS (\r\n" + "    SELECT \r\n" + "        a.displayseq, \r\n"
			...
			+ "GROUP BY h.accountcode, h.accountname, h.quater, h.display_sequence\r\n"
			+ "ORDER BY CAST(display_sequence AS UNSIGNED), h.quater ASC")
	Set<Object[]> getELPyAutomaticDetails(Long orgId, String previousYear, String clientCode, String mainGroupName,
			String month);
	...
	@Query(nativeQuery = true, value = "SELECT accountname,\r\n" + "       quater,\r\n" + "       SUM(amount)\r\n"
			...
			+ "FROM previousyearactual\r\n" + "WHERE orgid = ?1\r\n" + "  AND maingroup = ?4\r\n"
			+ "  AND clientcode = ?3\r\n" + "  AND subgroup = ?5\r\n" + "  AND year = ?2\r\n" + "GROUP BY accountname")
	Set<Object[]> getELPyRatioAnalysisDetails(Long orgId, String previousYear, String clientCode, String mainGroupName,
			String subGroupName, String month);
	...
	@Query(nativeQuery = true, value = "SELECT \r\n" + "    t.description,\r\n" + "    t.natureofaccount,\r\n"
			...
			+ "    GROUP BY description, natureofaccount\r\n" + ") t\r\n"
			+ "GROUP BY t.description, t.natureofaccount, t.quater")
	Set<Object[]> getELPySalesPurchaseAnalysisDetails(Long orgId, String previousYear, String clientCode, String type,
			String month);

	@Modifying
	@Transactional
	@Query(value = "DELETE FROM budget " + "WHERE orgid = ?1 " + "AND clientcode = ?2 " + "AND year = ?3 "
			+ "AND maingroup = ?4 " + "AND subgroup = ?5 " + "AND month = ?6", nativeQuery = true)
	...
	Set<Object[]> getELActualOrderBooking(Long orgId, String clientCode, String finYear, String month,
			String previousYear, String type);
