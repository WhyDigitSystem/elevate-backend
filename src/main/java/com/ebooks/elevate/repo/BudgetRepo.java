...
//			+ "    a.natureofaccount,gl.displayseq ORDER BY cast(gl.displayseq as unsigned) ASC")
	...
	@Query(nativeQuery = true, value = "SELECT\r\n"
			...
			+ "			        SUM(truncate(amount/?8,2)*?8) AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, SUM(truncate(amount/?8,2)*?8) AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, SUM(truncate(amount/?8,2)*?8) AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, SUM(truncate(amount/?8,2)*?8) AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM budget\r\n"
			+ "			    WHERE orgid = ?1\r\n"
			+ "			      AND clientcode = ?2\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, SUM(truncate(amount/?8,2)*?8) AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
			+ "			    WHERE orgid = ?1\r\n"
			+ "			      AND clientcode = ?2\r\n"
			...
			+ "			    SELECT\r\n"
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, SUM(truncate(amount/?8,2)*?8) AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
			+ "			    WHERE orgid = ?1\r\n"
			+ "			      AND clientcode = ?2\r\n"
			...
			+ "			        SUM(truncate(amount/?8,2)*?8) AS fullBudget, 0 AS fullPY\r\n"
			+ "			    FROM budget\r\n"
			...
			+ "			        maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "			        0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "			        0 AS fullBudget, SUM(truncate(amount/?8,2)*?8) AS fullPY\r\n"
			+ "			    FROM previousyearactual\r\n"
	...
	Set<Object[]> getELActualDetails(Long orgId, String clientCode, String finyear, String previousYear, String month,
			String mainGroupName, String subGroupCode,int findDivideamount);
...
//			+ "GROUP BY h.accountcode, h.accountname")
	@Query(nativeQuery = true, value = "WITH params AS (     SELECT          ?1 AS orgid,\r\n"
			...
			+ "						    ROUND(SUM(h.budget), 2) AS budget,     ROUND(SUM(h.actual), 2) AS actual,\r\n"
			+ "						    ROUND(SUM(h.PY), 2) AS PY,    ROUND(\r\n"
			+ "			        SUM(\r\n"
			+ "			            CASE\r\n"
			...
			+ "						    -- budget\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           SUM(truncate(amount/?7,2)*?7) budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			...
			+ "						     UNION      -- actual\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, SUM(truncate(amount/?7,2)*?7) actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			...
			+ "						     UNION      -- PY\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, SUM(truncate(amount/?7,2)*?7) PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			...
			+ "						     UNION      -- budget YTD\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, SUM(truncate(amount/?7,2)*?7) budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid     LEFT JOIN budget b \r\n"
			+ "						        ON acc.accountname = h.subheading         AND b.accountname = j.accountname\r\n"
			...
			+ "						     UNION      -- Act YTD\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, SUM(truncate(amount/?7,2)*?7) ActYTD, 0 PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			...
			+ "						     UNION      -- PY YTD\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, SUM(truncate(amount/?7,2)*?7) PyYTD, 0 fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
			...
			+ "						     UNION      -- full budget\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, SUM(truncate(amount/?7,2)*?7) fullBudget, 0 fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid     LEFT JOIN budget b \r\n"
			+ "						        ON acc.accountname = h.subheading         AND b.accountname = j.accountname\r\n"
			...
			+ "						     UNION      -- full PY\r\n"
			+ "						    SELECT b.maingroup, b.subgroup, b.subgroupcode, acc.accountcode, acc.accountname, b.natureofaccount,\r\n"
			+ "						           0 budget, 0 actual, 0 PY, 0 budgetYTD, 0 ActYTD, 0 PyYTD, 0 fullBudget, SUM(truncate(amount/?7,2)*?7) fullPY,\r\n"
			+ "						           acc.displayseq AS display_sequence     FROM  Accounts acc\r\n"
			+ "						    LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "						    LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "						    LEFT JOIN previousyearactual b          ON acc.accountname = h.subheading\r\n"
	...
	Set<Object[]> getELActualDetailsAutomatic(Long orgId, String finyear, String clientCode, String mainGroupName,
			String month, String previousYear,int devideAmount);
	...
	@Query(nativeQuery = true, value = "WITH Months AS (\r\n" + "    SELECT 'April' AS month UNION ALL\r\n"
			...
			+ "    GROUP BY a.accountname, a.displayseq, a.accountcode, a.subgroupname, a.subgroupcode\r\n" + ")\r\n"
			+ "SELECT \r\n" + "    acc.accountcode,\r\n" + "    acc.accountname,\r\n" + "    m.month,\r\n"
			+ "    SUM(truncate(b.amount/?5,2)* ?5) AS total_amount\r\n" + "FROM Months m\r\n" + "CROSS JOIN Accounts acc\r\n"
			+ "LEFT JOIN automation h ON h.maingroupname = ?4\r\n"
			+ "LEFT JOIN automationdetails j ON h.automationid = j.automationid\r\n"
			+ "LEFT JOIN previousyearactual b \r\n" + "    ON acc.accountname = h.subheading\r\n"
			+ "    AND b.accountname=j.accountname\r\n" + "    AND j.accountname = b.accountname\r\n"
			...
			+ "ORDER BY \r\n" + "    CAST(acc.displayseq AS UNSIGNED),\r\n"
			+ "    FIELD(m.month, 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December', 'January', 'February', 'March')")
	Set<Object[]> getPYDetailsAuto(Long orgId, String finyear, String clientCode, String mainGroupName,int devideAmount);
