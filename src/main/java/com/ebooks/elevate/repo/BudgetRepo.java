...
//			+ "GROUP BY h.accountcode, h.accountname")
	@Query(nativeQuery = true, value = "WITH params AS (\r\n"
			...
			+ "    ROUND(\r\n"
			+ "        CASE \r\n"
			+ "            WHEN (?4='Balance Sheet' or  ?4= 'Profit And Loss Account') and h.accountname IN ('Opening Stock', 'Closing Stock','Stock') THEN SUM(h.budget)\r\n"
			...
			+ "    ROUND(\r\n"
			+ "        CASE \r\n"
			+ "            WHEN (?4='Balance Sheet' or  ?4= 'Profit And Loss Account') and h.accountname IN ('Opening Stock', 'Closing Stock','Stock') THEN SUM(h.actual)\r\n"
			+ "            ELSE SUM(h.ActYTD)\r\n"
			+ "        END,\r\n"
			+ "    2) AS ActYTD,\r\n"
			+ "    \r\n"
			...
			+ "    ROUND(\r\n"
			+ "        CASE \r\n"
			+ "            WHEN (?4='Balance Sheet' or  ?4= 'Profit And Loss Account') and h.accountname IN ('Opening Stock', 'Closing Stock','Stock') THEN SUM(h.py)\r\n"
			+ "            ELSE SUM(h.PyYTD)\r\n"
			+ "        END,\r\n"
			+ "    2) AS PyYTD,\r\n"
			+ "    \r\n"
