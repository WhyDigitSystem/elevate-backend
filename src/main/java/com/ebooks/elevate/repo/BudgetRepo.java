...
//			+ "    a.natureofaccount,gl.displayseq ORDER BY cast(gl.displayseq as unsigned) ASC")
	...
	@Query(nativeQuery = true, value = "SELECT \r\n" + "    a.maingroup,\r\n" + "    a.subgroup,\r\n"
			+ "    a.subgroupcode,\r\n" + "    a.accountcode,\r\n" + "    a.accountname,\r\n"
			+ "    a.natureofaccount,\r\n" + "    \r\n" + "    ROUND(SUM(\r\n"
			+ "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN a.budget  \r\n"
			+ "             ELSE a.budget END\r\n" + "    ), 2) AS budget,\r\n" + "    \r\n" + "    ROUND(SUM(\r\n"
			+ "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN a.actual  \r\n"
			+ "             ELSE a.actual END\r\n" + "    ), 2) AS actual,\r\n" + "    \r\n" + "    ROUND(SUM(\r\n"
			+ "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN a.PY  \r\n"
			+ "             ELSE a.PY END\r\n" + "    ), 2) AS PY,\r\n" + "    \r\n" + "    ROUND(SUM(\r\n"
			+ "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN a.budget \r\n"
			+ "             ELSE a.budgetYTD END\r\n" + "    ), 2) AS budgetYTD,\r\n" + "    \r\n"
			+ "    ROUND(SUM(\r\n" + "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN a.actual \r\n"
			+ "             ELSE a.ActYTD END\r\n" + "    ), 2) AS ActYTD,\r\n" + "    \r\n" + "    ROUND(SUM(\r\n"
			+ "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN a.PY \r\n"
			+ "             ELSE a.PyYTD END\r\n" + "    ), 2) AS PyYTD,\r\n" + "    \r\n" + "    ROUND(SUM(\r\n"
			+ "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN a.budget \r\n"
			+ "             ELSE a.fullBudget END\r\n" + "    ), 2) AS fullBudget,\r\n" + "    \r\n"
			+ "    ROUND(SUM(\r\n" + "        CASE WHEN a.maingroup in( 'Balance Sheet Schedule' ,'Closing Stock','Opening Stock') THEN  a.PY \r\n"
			+ "             ELSE a.fullPY END\r\n" + "    ), 2) AS fullPY,\r\n" + "    \r\n" + "    ROUND(\r\n"
			...
			+ "                 WHERE year = ?3 \r\n" + "                   AND month = ?5\r\n"
			+ "                 GROUP BY monthsequence)) * 12\r\n" + "        END\r\n" + "    ),\r\n" + "    2\r\n"
			+ ") AS Estimate,\r\n" + "    \r\n" + "    gl.displayseq\r\n" + "\r\n" + "FROM (\r\n"
			+ "SELECT maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "           SUM(amount) AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "           0 AS fullBudget, 0 AS fullPY\r\n" + "    FROM budget\r\n"
			+ "    WHERE orgid = ?1 AND clientcode = ?2 AND year = ?3 AND month = ?5\r\n"
			+ "    GROUP BY maingroup, subgroup, subgroupcode, accountcode, natureofaccount, accountname\r\n" + "\r\n"
			+ "    UNION\r\n" + "\r\n"
			+ "    SELECT maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "           0 AS budget, SUM(amount) AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "           0 AS fullBudget, 0 AS fullPY\r\n" + "    FROM previousyearactual\r\n"
			+ "    WHERE orgid = ?1 AND clientcode = ?2 AND year = ?3 AND month = ?5\r\n"
			+ "    GROUP BY maingroup, subgroup, natureofaccount, subgroupcode, accountcode, accountname\r\n" + "\r\n"
			+ "    UNION\r\n" + "\r\n"
			+ "    SELECT maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "           0 AS budget, 0 AS actual, SUM(amount) AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "           0 AS fullBudget, 0 AS fullPY\r\n" + "    FROM previousyearactual\r\n"
			+ "    WHERE orgid = ?1 AND clientcode = ?2 AND year = ?4 AND month = ?5\r\n"
			+ "    GROUP BY maingroup, subgroup, natureofaccount, subgroupcode, accountcode, accountname\r\n" + "\r\n"
			+ "    UNION\r\n" + "\r\n"
			+ "    SELECT maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "           0 AS budget, 0 AS actual, 0 AS PY, SUM(amount) AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "           0 AS fullBudget, 0 AS fullPY\r\n" + "    FROM budget\r\n"
			...
			+ "\r\n" + "    UNION\r\n" + "\r\n"
			+ "    SELECT maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "           0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, SUM(amount) AS ActYTD, 0 AS PyYTD,\r\n"
			+ "           0 AS fullBudget, 0 AS fullPY\r\n" + "    FROM previousyearactual\r\n"
			+ "    WHERE orgid = ?1 AND clientcode = ?2 AND year = ?3\r\n"
			...
			+ "    UNION\r\n" + "\r\n"
			+ "    SELECT maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "           0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, SUM(amount) AS PyYTD,\r\n"
			+ "           0 AS fullBudget, 0 AS fullPY\r\n" + "    FROM previousyearactual\r\n"
			...
			+ "           SUM(amount) AS fullBudget, 0 AS fullPY\r\n" + "    FROM budget a\r\n"
			+ "    WHERE a.orgid = ?1 AND a.clientcode = ?2 AND a.year = ?3\r\n"
			+ "    GROUP BY maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount\r\n" + "\r\n"
			+ "    UNION\r\n" + "\r\n"
			+ "    SELECT maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount,\r\n"
			+ "           0 AS budget, 0 AS actual, 0 AS PY, 0 AS budgetYTD, 0 AS ActYTD, 0 AS PyYTD,\r\n"
			+ "           0 AS fullBudget, SUM(amount) AS fullPY\r\n" + "    FROM previousyearactual a\r\n"
			+ "    WHERE a.orgid = ?1 AND a.clientcode = ?2 AND a.year = ?4\r\n"
			+ "    GROUP BY maingroup, subgroup, subgroupcode, accountcode, accountname, natureofaccount\r\n"
...
//			+ "GROUP BY h.accountcode, h.accountname")
	@Query(nativeQuery = true, value = "WITH params AS (\r\n" + "    SELECT \r\n" + "        ?1 AS orgid,\r\n"
			...
			+ "        b.pyamount AS PY,\r\n" + "        b.ytbudgetamount AS budgetYTD,\r\n"
			+ "        b.ytactualamount AS ActYTD,\r\n" + "        b.ytpyamount AS PyYTD,\r\n"
			+ "        b.fullbudgetamount AS fullBudget,\r\n" + "        b.estimateamount AS Estimate,\r\n"
			+ "        b.fullpyamount AS fullPY\r\n" + "    FROM budget b \r\n" + "    JOIN params p\r\n"
			...
			+ "    ROUND(SUM(h.budget), 2) AS budget,\r\n" + "    ROUND(SUM(h.actual), 2) AS actual,\r\n"
			+ "    ROUND(SUM(h.PY), 2) AS PY,\r\n" + "    -- ✅ Budget YTD\r\n" + "    ROUND(\r\n" + "        CASE \r\n"
			+ "            WHEN ?4='Balance Sheet' THEN SUM(h.budget)\r\n" + "            ELSE SUM(h.budgetYTD)\r\n"
			+ "        END,\r\n" + "    2) AS budgetYTD,\r\n" + "    \r\n" + "    -- ✅ Actual YTD\r\n"
			+ "    ROUND(\r\n" + "        CASE \r\n" + "            WHEN ?4='Balance Sheet'  THEN SUM(h.actual)\r\n"
			+ "            ELSE SUM(h.ActYTD)\r\n" + "        END,\r\n" + "    2) AS ActYTD,\r\n" + "    \r\n"
			+ "    -- ✅ PY YTD\r\n" + "    ROUND(\r\n" + "        CASE \r\n"
			+ "            WHEN ?4='Balance Sheet' THEN SUM(h.py)\r\n" + "            ELSE SUM(h.PyYTD)\r\n"
			+ "        END,\r\n" + "    2) AS PyYTD,\r\n" + "    \r\n" + "    -- ✅ Full Budget\r\n" + "    ROUND(\r\n"
			+ "        CASE \r\n" + "            WHEN ?4='Balance Sheet' THEN SUM(h.budget)\r\n"
			+ "            ELSE SUM(h.fullBudget)\r\n" + "        END,\r\n" + "    2) AS fullBudget,\r\n" + "    \r\n"
			+ "    -- ✅ Estimate\r\n" + "    ROUND(\r\n" + "        CASE \r\n"
			+ "            WHEN ?4='Balance Sheet' THEN SUM(h.actual)\r\n" + "            ELSE (SUM(h.actYTD) /\r\n"
			+ "         (SELECT monthsequence FROM budget WHERE year = ?2 AND month = ?5 GROUP BY monthsequence)) * 12\r\n"
			+ "        END,\r\n" + "    2) AS Estimate,\r\n" + "    \r\n" + "    -- ✅ Full PY\r\n" + "    ROUND(\r\n"
	...
	Set<Object[]> getELActualDetailsAutomatic(Long orgId, String finyear, String clientCode, String mainGroupName,
			String month, String previousYear);
