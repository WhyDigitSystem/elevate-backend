...
public class BudgetController extends BaseController {
	...
	public ResponseEntity<ResponseDTO> getGroupLedgers(@RequestParam Long orgId,@RequestParam String mainGroup,@RequestParam String subGroupCode) {
		...
		try {
			groupLedgers = budgetService.getGroupLedgersDetails(orgId, mainGroup,subGroupCode);
		} catch (Exception e) {
			errorMsg = e.getMessage();
			LOGGER.error(UserConstants.ERROR_MSG_METHOD_NAME, methodName, errorMsg);
		}
