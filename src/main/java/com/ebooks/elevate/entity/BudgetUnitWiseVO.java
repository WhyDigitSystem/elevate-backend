...
@Entity
@Table(name="budgetunit")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class BudgetUnitWiseVO {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "budgetunitgen")
	@SequenceGenerator(name = "budgetunitgen", sequenceName = "budgetunitseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "budgetunitid")
	private Long id;
