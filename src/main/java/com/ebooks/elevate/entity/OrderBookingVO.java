...
public class OrderBookingVO {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "budgetobgen")
	@SequenceGenerator(name = "budgetobgen", sequenceName = "budgetobseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "budgetobid")
	private Long id;
