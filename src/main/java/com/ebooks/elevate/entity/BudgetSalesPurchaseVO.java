...
@Entity
@Table(name="budgetsalespurchase")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class BudgetSalesPurchaseVO {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "budgetsalespurchasegen")
	@SequenceGenerator(name = "budgetsalespurchasegen", sequenceName = "budgetsalespurchaseseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "budgetsalespurchaseid")
	private Long id;
