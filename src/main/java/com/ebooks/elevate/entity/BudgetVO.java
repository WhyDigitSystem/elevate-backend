...
public class BudgetVO {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "budgetgen")
	@SequenceGenerator(name = "budgetgen", sequenceName = "budgetseq", initialValue = 1000000001, allocationSize = 1)
