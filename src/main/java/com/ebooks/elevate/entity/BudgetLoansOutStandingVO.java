...
@Entity
@Table(name="budgetloanoutstanding")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class BudgetLoansOutStandingVO {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "budgetloanoutstandinggen")
	@SequenceGenerator(name = "budgetloanoutstandinggen", sequenceName = "budgetloanoutstandingseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "budgetloanoutstandingid")
	private Long id;
